...
replace (
	github.com/gnolang/gno => github.com/allinbits/gno v0.0.0-20260403155940-f9fee3f01ccc
	github.com/gnolang/gno/contribs/gnodev => github.com/allinbits/gno/contribs/gnodev v0.0.0-20260403155940-f9fee3f01ccc
)
